  ...
  return (
    <section className="bg-[#FDF6ec] py-16">
      <div className="container px-4  mx-auto ">
        ...
        <div className="space-y-6 ml-6 mt-10">  
            {/* //Container do sobre  */}
        ...
        <div className='mt-6 flex flex-wrap gap-4'>
            ...
            <a href="#" className="  px-5 py-2 text-black w-fit rounded-md font-semibold    hover:underline">
                Endereço da Loja
                <MapPinIcon className='inline w-5 h-5 ml-2' />
                </a>
        </div>
